...
namespace cologne
{
    void PlayerController::update_camera(float dt)
    {
    ...
    void PlayerController::move_viewmodel(float dt)
    {
    ...
    void PlayerController::apply_friction(float t, float dt)
    {
    ...
    void PlayerController::acceleration(glm::vec3 goal_dir, float goal_speed, float accel, float dt)
    {
    ...
    void PlayerController::ground_move(glm::vec3 movement_input, float dt)
    {
    ...
    void PlayerController::air_move(glm::vec3 movement_input, bool strafing_only, float dt)
    {
        float accel;
    ...
    void PlayerController::air_control(glm::vec3 movement_input, float target_speed, bool only_forward, float dt)
    {
    ...
    void PlayerController::queue_jump()
    {
    ...
    void PlayerController::update_gun(float dt)
    {
